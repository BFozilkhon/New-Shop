...
if (has_buf) {
  ...
  mdl = 1024, mdb = Buffer.allocUnsafe(mdl);
  make_EE = function make_EE2(E) {
  ...
  magic_encode[65001] = function utf8_e(data, ofmt) {
    if (has_buf && /*::data instanceof Buffer && */
    Buffer.isBuffer(data)) {
...
var decode = function decode2(cp, data) {
  ...
  if (C && (D = C.dec)) {
    ...
    case "ascii":
      if (has_buf && /*::data instanceof Buffer && */
      Buffer.isBuffer(data)) return data.toString(M);
...
xlsx/dist/cpexcel.full.mjs:
  (*! cpexcel.mjs (C) 2013-present SheetJS -- http://sheetjs.com *)

xlsx/dist/cpexcel.full.mjs:
  (*! cputils.js (C) 2013-present SheetJS -- http://sheetjs.com *)
*/
//# sourceMappingURL=xlsx_dist_cpexcel__full__mjs.js.map
